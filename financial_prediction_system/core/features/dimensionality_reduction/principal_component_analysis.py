...
class PCAReducer(DimensionalityReducer):
    ...
    def __init__(
        ...
        whiten : bool, default=False
            ...
            and then divided by the singular values to ensure uncorrelated outputs
        random_state : int, optional
            Random state for reproducibility
        prefix : str, default="pca_"
            Prefix to add to feature names
        """
        super().__init__(n_components=n_components, prefix=prefix)
        self.whiten = whiten
    ...
    def fit(self, data: pd.DataFrame) -> 'PCAReducer':
        """
        ...
        """
        self.model.fit(data)
        self.feature_names = [f"{self.prefix}{i}" for i in range(self.model.n_components_)]
        return self
