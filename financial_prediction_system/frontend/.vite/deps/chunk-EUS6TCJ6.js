...
var SvgIcon = React38.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React38.isValidElement(children2) && children2.type === "svg";
  const ownerState = _extends({}, props, {
    color: color2,
    component,
    fontSize: fontSize2,
  ...
  return (0, import_jsx_runtime17.jsxs)(SvgIconRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children2.props.children : children2, titleAccess ? (0, import_jsx_runtime16.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime18.jsx)(SvgIcon_default, _extends({
...
var Paper = React40.forwardRef(function Paper2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiPaper"
  });
...
var Portal = React41.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React41.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React41.isValidElement(children2)) {
      ...
      return React41.cloneElement(children2, newProps);
    }
...
var TextareaAutosize = React42.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const didHeightChange = useEventCallback_default(() => {
    ...
    if (!textarea || !textareaStyles || isEmpty3(textareaStyles)) {
      return false;
    }
  ...
  return (0, import_jsx_runtime22.jsxs)(React42.Fragment, {
...
var InputBase = React46.forwardRef(function InputBase2(inProps, ref) {
...
ReplaceTransition.propTypes = true ? {
  in: import_prop_types32.default.bool.isRequired,
...
SwitchTransition.propTypes = true ? {
   ...
   * @type {'out-in'|'in-out'}
   */
  mode: import_prop_types33.default.oneOf([modes.in, modes.out]),
  /**
   * Any `Transition` or `CSSTransition` component.
   */
  children: import_prop_types33.default.oneOfType([import_prop_types33.default.element.isRequired])
} : {};
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EUS6TCJ6.js.map
