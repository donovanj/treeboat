...
from financial_prediction_system.core.models.classification.random_forest import RandomForestModel
...
class TestRandomForestModel:
    ...
    def test_init_custom_params(self):
        ...
        assert model.model.max_features == 0.8
    ...
    def test_implements_prediction_model_interface(self):
        """Test that RandomForestModel implements PredictionModel interface."""
        # Arrange & Act
        model = RandomForestModel()
...
class TestRandomForestWithFactory:
    """Tests for the Random Forest model with factory."""
    
    def test_factory_registration(self):
        """Test that the model is registered with the factory."""
        assert "random_forest" in ModelFactory.get_available_models()
    
    def test_factory_create_random_forest(self):
        """Test creating the model through the factory."""
        # Act
        model = ModelFactory.create("random_forest", n_estimators=150, random_state=42)
